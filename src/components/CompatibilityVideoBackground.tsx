...
export default function CompatibilityVideoBackground() {
  const imageUrl = "https://raw.githubusercontent.com/jkbharti159/Patriotic-images/main/_%20(7)%20(1).jpeg";
    ...
    <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden select-none z-0">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        <motion.img
          ...
          alt="Divine Cosmic Synergy Compatibility Form"
