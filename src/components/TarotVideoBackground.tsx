...
export default function TarotVideoBackground() {
  const imageUrl = "https://raw.githubusercontent.com/jkbharti159/Patriotic-images/main/_%20(4).jpeg";
